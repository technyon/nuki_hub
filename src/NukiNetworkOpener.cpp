...
void NukiNetworkOpener::publishAuthorizationInfo(const std::list<NukiOpener::LogEntry>& logEntries)
{
    char str[50];
...
void NukiNetworkOpener::logactionCompletionStatusToString(uint8_t value, char* out)
{
    switch (value)
    {
        case 0x00:
...
void NukiNetworkOpener::publishHASSConfig(char* deviceType, const char* baseTopic, char* name, char* uidString, char* lockAction, char* unlockAction, char* openAction)
{
...
void NukiNetworkOpener::publishTimeControl(const std::list<NukiOpener::TimeControlEntry>& timeControlEntries)
{
    char str[50];
    JsonDocument json;
...
void NukiNetworkOpener::publishFloat(const char *topic, const float value, const uint8_t precision)
{
    _network->publishFloat(_mqttPath, topic, value, precision);
}

void NukiNetworkOpener::publishInt(const char *topic, const int value)
{
    _network->publishInt(_mqttPath, topic, value);
}

void NukiNetworkOpener::publishUInt(const char *topic, const unsigned int value)
{
...
void NukiNetworkOpener::publishString(const char *topic, const String &value)
{
...
void NukiNetworkOpener::publishString(const char *topic, const std::string &value)
{
...
void NukiNetworkOpener::publishString(const char* topic, const char* value)
{
